...
- **Farm Risk**: KVC risk calculator, profiles, and crowdsourced assessments
...
If Google Sheets is unavailable, the app automatically falls back to local CSV files.
